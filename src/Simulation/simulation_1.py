...
@author: mwitt_000
'''
from src.Network import network_1
from src.Link import link_1
import threading
...
if __name__ == '__main__':
    ...
    client.udt_send(2, 'Sample data must be longer then 80 characters so we added in this additional text.',
